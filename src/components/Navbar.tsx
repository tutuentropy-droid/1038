...
import { Film, Heart, Search, Menu, X, Clock, Users, Hammer, Search as SearchIcon, Trophy, Gamepad2, Wrench, Sparkles, Globe, Clapperboard, Popcorn } from 'lucide-react';
...
export const Navbar = () => {
  ...
  const navLinks = [
    ...
    { path: '/theater', label: '大剧院', icon: Popcorn },
